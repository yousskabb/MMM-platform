...
const DataTab: React.FC<DataTabProps> = ({ filters }) => {
    ...
    const { channelData, monthlyData, contributions: weeklyContributions, investments: weeklyInvestments, dateRange } = filterData(filters.dateRange.startDate, filters.dateRange.endDate);
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <div className="text-sm text-slate-500">
                    Filtered from {filters.dateRange.startDate.toLocaleDateString()} to {filters.dateRange.endDate.toLocaleDateString()}
                </div>
            </div>
            ...
            <div className="bg-white rounded-lg border">
                ...
                <div className="p-4 space-y-2">
                    <p className="text-sm"><strong>Filter Date Range:</strong> {filters.dateRange.startDate.toLocaleDateString()} to {filters.dateRange.endDate.toLocaleDateString()}</p>
                    <p className="text-sm"><strong>Available Date Range:</strong> {dateRange.min.toLocaleDateString()} to {dateRange.max.toLocaleDateString()}</p>
