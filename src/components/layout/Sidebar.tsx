...
type Tab = 'recap' | 'roi' | 'budget' | 'simulations' | 'response' | 'chat';
            ...
            {tabs.map((tab) => (
              <li key={tab.id}>
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 text-left rounded-md transition-colors ${activeTab === tab.id
